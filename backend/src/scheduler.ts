...
import { remindTomorrow, cekJadwalMingguDepan } from './cron/reminder-wfo';
...
export function startScheduler() {
  ...
  // Roster pekan depan tidak terbit pada jam yang tetap dan bisa diterbitkan ulang, jadi
  // dicek tiga malam; Sabtu dan Minggu hanya bersuara bila ada yang baru atau berubah.
  schedule('0 21 * * 0,5,6', cekJadwalMingguDepan); // Jum-Min 21:00
